...
if __name__=="__main__":
    ...
    np.savetxt(f"data/lstm_square_pred.csv", np.transpose(np.vstack((pred_time, pred_data))), delimiter=",")
    ...
    np.savetxt(f"data/lstm_square_recon.csv", np.transpose(np.vstack((pred_time, pred_lstm.reshape((1,nstep))))), delimiter=",")
    ...
    plt.savefig("Figures/lstm_square.png", dpi=400)
    ...
    plt.savefig(f"Figures/lstm_square_loss.png", dpi=400)